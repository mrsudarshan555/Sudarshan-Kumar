...
**Already in a Claude Code session with your agent?** One sentence does the whole install: *"clone #, then read ai-visualizer/ai-visualizer.md and set me up."* Your agent clones it, runs the wizard, and wires it in for you.
