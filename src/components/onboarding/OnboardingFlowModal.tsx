        ...
        <div className="relative flex-1 w-full h-full flex flex-col justify-between overflow-y-auto px-6 py-6 scrollbar-none">
          ...
          <div className="flex-1 py-3 space-y-4">
            <div className="text-center space-y-1">
              ...
              <p className="text-xs text-gray-400 max-w-xs mx-auto">
                Live updates applied on tap! Default is our signature Cosmic Purple.
              </p>
            </div>

            {/* Dark Mode vs Light Mode Real-time Toggles */}
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`p-3.5 rounded-2xl border flex flex-col items-center gap-2 transition-all cursor-pointer ${
                  appearanceConfig.darkMode
                    ? 'bg-[#1a1c24] border-purple-500 shadow-[0_0_15px_rgba(168,85,247,0.35)] text-white'
                    : 'bg-[#121318] border-white/10 text-gray-400 hover:border-white/20'
                }`}
              >
                <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${
                  appearanceConfig.darkMode ? 'bg-purple-500/20 text-purple-300' : 'bg-white/5 text-gray-400'
                }`}>
                  <Moon className="w-5 h-5" />
                </div>
                <div className="text-center">
                  <span className="text-xs font-bold block">Dark Mode</span>
                  <span className="text-[10px] text-gray-400">Deep AMOLED Black</span>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <span className="text-[10px] text-gray-400">Bright Clean Canvas</span>
                </div>
              </button>
            </div>
            ...
            <div className="space-y-2">
              <span className="text-xs font-bold text-gray-300 tracking-wider uppercase block">
                Accent Color Palette
              </span>
              <div className="grid grid-cols-2 gap-2">
                {THEME_OPTIONS.map((theme) => {
                  const isSelected = appearanceConfig.appTheme === theme.id;
                  return (
                    <div
                      key={theme.id}
                      ...
                      className={`p-2.5 rounded-xl border flex items-center gap-2.5 transition-all cursor-pointer ${
                        isSelected
                          ? 'bg-[#1a1b26] border-purple-500 shadow-[0_0_12px_rgba(168,85,247,0.35)]'
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-[9px] text-gray-400 truncate">{theme.desc}</p>
                      </div>
                    </div>
                  );
                })}
          ...
          {/* Confirm Theme & Continue Button */}
          <div className="pt-3 shrink-0">
            <button
              onClick={() => setCurrentStep(5)} // Show final ready welcome hero with user's customized name!
              className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-sm tracking-wide shadow-lg shadow-purple-600/30 flex items-center justify-center gap-2 cursor-pointer transition-all active:scale-[0.99]"
            >
              <span>Save Theme & Ready to Launch (थीम लागू करें)</span>
              <ArrowRight className="w-4 h-4" />
            </button>
          </div>
        </div>
