  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto bg-transparent text-slate-200">
      ...
      <div className="p-4 space-y-4 text-xs font-sans pb-8">
        ...
        <div className="p-6 bg-white/[0.07] backdrop-blur-2xl border border-white/15 rounded-3xl flex flex-col items-center justify-center text-center space-y-3 shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_1px_1px_rgba(255,255,255,0.2)]">
        ...
        <div className="p-3.5 bg-white/[0.07] backdrop-blur-2xl border border-white/15 rounded-3xl space-y-2.5 shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_1px_1px_rgba(255,255,255,0.2)]">
        ...
        <div className="p-3.5 bg-white/[0.07] backdrop-blur-2xl border border-white/15 rounded-3xl space-y-2.5 shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_1px_1px_rgba(255,255,255,0.2)]">
          ...
          <div className="space-y-1.5 text-[11px]">
            <div className="flex justify-between p-2.5 bg-white/[0.06] backdrop-blur-xl rounded-2xl border border-white/10">
        ...
        <div className="p-3.5 bg-white/[0.07] backdrop-blur-2xl border border-purple-500/30 rounded-3xl space-y-2 shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_1px_1px_rgba(255,255,255,0.2)]">
          <div className="text-[11px] font-sans font-bold text-purple-300 uppercase flex items-center gap-1.5">
        ...
        <div className="p-3.5 bg-white/[0.07] backdrop-blur-2xl border border-white/15 rounded-3xl space-y-3 shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_1px_1px_rgba(255,255,255,0.2)]">
          ...
          <div className="space-y-2 text-[11px] font-sans text-slate-300">
            ...
            <div className="p-2.5 bg-white/[0.06] backdrop-blur-xl rounded-2xl border border-emerald-500/20 space-y-1">
