      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-6 scrollbar-none pb-28">
        ...
        <div className="p-4 rounded-2xl bg-[#121318] border border-white/5 space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-[#1a1b24] border border-white/10 flex items-center justify-center text-[#ff2a4b]">
            ...
            <a
              ...
              className="text-[11px] text-[#ff2a4b] hover:underline flex items-center gap-1"
            >
              <span>Get key</span>
          ...
          <input
            ...
            className="w-full bg-[#15161d] border border-white/10 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-gray-600 outline-none focus:border-[#ff2a4b]/60 transition-colors font-mono"
          />
        </div>
              ...
              return (
                <div
                  ...
                  className={`p-3.5 rounded-2xl bg-[#121318] border transition-all cursor-pointer flex items-center justify-between ${
                    isSelected
                      ? 'border-[#ff2a4b]/50 shadow-[0_0_15px_rgba(255,42,75,0.15)] bg-[#161720]'
                ...
                >
                  ...
                  <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${
                    isSelected ? 'border-[#ff2a4b] bg-[#ff2a4b]' : 'border-gray-600'
                  }`}>
        ...
        <div className="p-4 rounded-2xl bg-[#121318] border border-white/5 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#ff2a4b]/10 text-[#ff2a4b]">
              Ready
            </span>
          </div>
          <p className="text-[11px] text-gray-400">
